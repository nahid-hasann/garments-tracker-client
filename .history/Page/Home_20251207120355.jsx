                    ...
                    >
                        <div className="bg-white rounded-xl shadow-sm p-5 border border-slate-200">
                            <p className="text-slate-600 text-sm mb-2">
                                “GarmentsTracker has helped us improve on-time delivery significantly.
                            The production overview is super helpful.”
                            </p>
                            <p className="font-semibold text-slate-900 text-sm">Maya Thompson</p>
                            <p className="text-[11px] text-slate-400">Dhaka Apparel Ltd</p>
                        </div>

                        <div className="bg-white rounded-xl shadow-sm p-5 border border-slate-200">
                            <p className="text-slate-600 text-sm mb-2">
                                “Tracking cutting, sewing, and finishing stages became incredibly easy.
                            Our team is now more organized than ever.”
                            </p>
                            <p className="font-semibold text-slate-900 text-sm">Production Manager</p>
                            <p className="text-[11px] text-slate-400">Gazipur Knit Factory</p>
                        </div>

                        <div className="bg-white rounded-xl shadow-sm p-5 border border-slate-200">
                            <p className="text-slate-600 text-sm mb-2">
                                “The dashboard is clean and user-friendly.
                            I can track my orders anytime without depending on email updates.”
                            </p>
                            <p className="font-semibold text-slate-900 text-sm">Oliver Carter</p>
                            <p className="text-[11px] text-slate-400">Buying House, Uttara</p>
                        </div>
                    </Carousel>
                </div>
            </section>
