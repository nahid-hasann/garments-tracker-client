...
const AuthProvider = ({ children }) => {
    ...
    // ❌ এই লাইনটা বাদ দিন, এটাই এরর দিচ্ছিল
    // const axiosSecure = useAxiosSecure(); 

    // ✅ এর বদলে সাধারণ Axios ইনস্ট্যান্স তৈরি করুন
    const axiosPublic = axios.create({
        baseURL: 'https://garments-tracker-server.vercel.app', // আপনার লাইভ সার্ভার লিংক
        withCredentials: true // কুকি আদান-প্রদানের জন্য জরুরি
    });
