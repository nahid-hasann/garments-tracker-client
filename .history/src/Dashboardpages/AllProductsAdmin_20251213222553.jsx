...
import useAxiosSecure from "../Hook /useAxiosSecure"; // আপনার পাথ অনুযায়ী ঠিক করুন
...
const AllProductsAdmin = () => {
    ...
    // ✅ TanStack Query দিয়ে ডাটা লোড করা (সবচেয়ে নিরাপদ উপায়)
    const { data: products = [], refetch, isLoading } = useQuery({
        queryKey: ['products'],
        queryFn: async () => {
            // এখানে লিমিট বাড়িয়ে দিচ্ছি যাতে সব প্রোডাক্ট একসাথে দেখা যায়
            const res = await axiosSecure.get('/products?limit=1000&page=1');
            // আপনার সার্ভার যদি { products: [...], total: ... } রিটার্ন করে
