...
const MyOrders = () => {
    ...
    const renderPaymentBadge = (order) => {
        ...
        if (!method) {
            return <span className="badge badge-outline">Not set</span>;
        }

        // Cash on Delivery
        if (method === "Cash on Delivery") {
            return <span className="badge badge-ghost">Cash on Delivery</span>;
        }

        // PayFirst / Online
        if (method === "PayFirst") {
            if (status === "paid") {
                return <span className="badge badge-success">Paid (PayFirst)</span>;
            }
            ...
            {orders.length === 0 ? (
                <div className="min-h-[30vh] flex flex-col items-center justify-center text-slate-500 text-sm">
                    ...
                    <p className="text-xs mt-1">
                        Go to <span className="font-semibold">All Products</span> and
                        place a booking.
                    </p>
                </div>
            ) : (
