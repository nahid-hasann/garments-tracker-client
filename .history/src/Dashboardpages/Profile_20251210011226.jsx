...
const Profile = () => {
    ...
    return (
        <div className="space-y-4">
            ...
            {/* Placeholder: later suspend feedback / extra info */}
            <div className="bg-white border border-dashed border-slate-200 rounded-xl p-4 text-xs text-slate-500">
                Later এখানে তুমি:
                <ul className="list-disc list-inside mt-1 space-y-1">
                    <li> Suspend reason / feedback দেখাতে পারবে</li>
                    <li> Buyer হলে: "why suspended" message দেখানো</li>
                    <li> Manager হলে: কী কী permission block, সেটা দেখানো</li>
                </ul>
            </div>
        </div>
    );
