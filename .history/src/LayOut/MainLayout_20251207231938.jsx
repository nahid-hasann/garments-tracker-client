                        ...
                        <div className="hidden md:flex items-center gap-4 text-sm">
                            {user ? (
                                <>
                                    ...
                                    {/* Logout */}
                                    <Link onClick={logOutt} className="px-3 py-1.5 rounded-full border border-slate-200 text-slate-700 hover:border-blue-500 hover:text-blue-600 text-xs transition-colors" > Log out </Link>
                                </>
                            ) : (
                                <>
                                    <Link
