                        ...
                        <div className="hidden md:flex items-center gap-4 text-sm">
                            {user ? (
                                <div className="flex items-center gap-3">
                                    {/* 1. Direct Logout Button (As you requested) */}
                                    <button
                                        onClick={handleLogout}
                                        className="px-4 py-2 rounded-full border border-slate-200 text-slate-600 font-semibold hover:bg-slate-100 hover:text-red-600 transition-colors text-xs flex items-center gap-1"
                                    >
                                        <FaSignOutAlt /> Log out
                                    </button>

                                    {/* 2. Dropdown Menu (Restored) */}
                                    <div className="dropdown dropdown-end">
                                        ...
                                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow-xl bg-white rounded-xl w-60 border border-slate-100">
                                            ...
                                            {/* Menu Items */}
                                            <li><Link to="/dashboard" className="py-2.5 text-slate-600 hover:text-blue-600 font-medium">Dashboard</Link></li>
                                            <li><Link to="/dashboard/profile" className="py-2.5 text-slate-600 hover:text-blue-600">My Profile</Link></li>
                                            <div className="divider my-1"></div>
                                            {/* Logout inside Dropdown too */}
