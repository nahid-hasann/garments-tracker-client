        ...
        <div className="space-y-16 pb-10">
            ...
            <section className="space-y-6">
                {isLoading ? (
                    ...
                    >
                        {/* ... (আগের প্রোডাক্ট ম্যাপ করার কোড) ... */}
                        {homeProducts.length === 0 ? (
                            <p>No products found</p>
                        ) : (
                            homeProducts.map(product => (
                                // ... আপনার আগের প্রোডাক্ট কার্ড কোড ...
                                <motion.div key={product._id} variants={cardVariants} className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
