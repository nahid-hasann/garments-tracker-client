...
// import useAuth from '../Hook/useAuth'; // পাথ ঠিক আছে কিনা দেখে নিবেন
import toast from 'react-hot-toast';
import { Helmet } from "react-helmet-async";
// import useAxiosSecure from '../Hook/useAxiosSecure'; // পাথ ঠিক আছে কিনা দেখে নিবেন

const Login = () => {
    const { logInWithGoogle, signIn } = useAut();
                ...
                <div className="px-6 py-8 md:px-8 md:py-10">
                    ...
                    <div className="mb-6 bg-slate-50 p-3 rounded-lg border border-slate-100">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            <button
                                onClick={() => handleDemoLogin('admin123@gmail.com', 'Aa123456', 'Admin')}
                        ...
                        <div className="bg-white/10 border border-white/15 rounded-xl p-4 text-xs space-y-2">
                            ...
                            <div className="space-y-1 text-slate-300 text-[11px]">
                                <div className='flex justify-between'>
                                    <span>Admin:</span> <span className='font-mono'>admin123@gmail.com</span>
                                </div>
                                <div className='flex justify-between'>
