...
const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: "manage-products", element: <ManageProducts><ManageProducts /></ManageProducts> },
      { path: "pending-orders", element: <ManageProducts><PendingOrders /> </ManageProducts>},
      { path: "manage-users", element: <ManagerRoute><ManageUsers /></ManagerRoute> },
      { path: "all-products", element: <ManagerRoute><AllProductsAdmin /></ManagerRoute> },
      { path: "all-orders", element: <ManagerRoute><AllOrders /></ManagerRoute> },
